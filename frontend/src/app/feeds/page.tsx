...
const FRESHRSS_URL =
  process.env.NEXT_PUBLIC_FRESHRSS_URL ?? "https://forge.tail2cdf70.ts.net:8091";
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex items-center justify-between gap-3 border-b px-6 py-4">
        <div>
          <h1 className="text-lg font-semibold text-strong">Feeds</h1>
          <p className="text-xs text-muted">
            Self-hosted FreshRSS — structured feed substrate for trend-monitoring and
            bot watchers. Greader-compatible API at{" "}
            <code className="rounded bg-[color:var(--surface-muted)] px-1.5 py-0.5 text-[11px]">
              {FRESHRSS_URL}/api/greader.php
            </code>
            .
          </p>
        </div>
